...
parser.add_argument(
    ...
    metavar="p1",
    type=str,
    help="either human or an AI file",
    default="human",
)
parser.add_argument(
    "--player2",
...
parser.add_argument(
    ...
    "--load",
    type=str,
    help="file containing starting board setup (for repeatability)",
    default=None,
)
parser.add_argument(
    "-s", "--save", type=str, help="file to save board setup to", default=None
)
    ...
    for house in player1_cards.keys():
        ...
        # If the number of cards is the same, the player who chose the last card of that house gets the banner
            ...
            if last_house == house:
                ...
                if (
                    player1_banners[house] > player2_banners[house]
                ):  # If player 1 has more banners of the house
                    selected_player = 1

                elif (
                    player2_banners[house] > player1_banners[house]
